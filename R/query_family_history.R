...
#' e.g. Y13D = 1 and Y13E = 2. See \href{https://biobank.ndph.ox.ac.uk/showcase/refer.cgi?id=113241}{https://biobank.ndph.ox.ac.uk/showcase/refer.cgi?id=113241}
#' for more details.
#'
...
query_family_history <- function (conditions, query) {
  ...
  unknown_codes <- if (query %in% c(1, 2, 6, 8, 9, 10)) {
    c(-11, -13)
  } else if (query %in% c(3, 4, 11, 12, 13)) {
    c(-21, -23)
  } else {
